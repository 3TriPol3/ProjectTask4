...
class DeleteView(Tk):
    def __init__(self):
        ...
        self.label = ttk.Label(self.label_frame, text="Удалить транзакцию")
        self.label.pack()
        ...
        self.delete_button = ttk.Button(self.delete_frame, text="Удалить транзакцию", command=self.delete_post)
    ...
    def delete_post(self):
        TransactionController.delete(id=self.id)
        self.table()
